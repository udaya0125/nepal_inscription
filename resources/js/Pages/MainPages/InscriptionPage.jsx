...
//                     Error displaying content. Please check the format.
//                 </p>
//             );
//         }
//     };
...
//                 {/* Breadcrumbs overlay - top of hero */}
//                 <div className="absolute top-0 left-0 right-0 z-30 px-4 py-10">
//                     <nav aria-label="Breadcrumb" className="max-w-7xl mx-auto">
//                         <ol className="flex flex-wrap items-center gap-1 text-sm">
//                             <li className="flex items-center">
//                                 <button
//                                     onClick={() => router.visit("/")}
//                                     className="flex items-center gap-1 text-white/70 hover:text-white transition-colors font-medium"
//                                     aria-label="Home"
//                                 >
//                                     <Home size={14} />
//                                     <span>Home</span>
...
//                                 aria-current="page"
//                             >
//                                 <span className="text-white font-semibold truncate max-w-[160px] sm:max-w-xs md:max-w-sm">
//                                     {inscription?.title || "Inscription Detail"}
//                                 </span>
...
//                             {inscription.inscription_number
//                                 ? `Inscription ID: ${inscription.inscription_number}`
...
//                                         }`}
//                                         src={getImageUrl(
//                                             inscription.images[selectedImage]
//                                                 ?.image_path,
//                                         )}
...
//                                         poster={
//                                             inscription?.video_banner
//                                                 ? `${imgurl}/${inscription.video_banner}`
//                                                 : undefined
//                                         }
            ...
            <div className="max-w-7xl mx-auto px-4 py-8 md:py-12">
                ...
                <div className="max-w-5xl mx-auto mb-4 py-4">
                    ...
                    <div className="py-6 text-black font-medium leading-relaxed text-md sm:text-lg prose prose-lg max-w-none">
                        ...
                        {activeTab === "Description" &&
                            inscription.google_maps_link && (
                                <p className="mt-4 not-prose">
                                    <a
                                        href={inscription.google_maps_link}
                                        target="_blank"
