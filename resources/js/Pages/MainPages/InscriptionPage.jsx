        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
            ...
            <div className="relative h-64 md:h-80 lg:h-96 overflow-hidden">
                ...
                <img
                    ...
                    src={getImageUrl(inscription.banner_image) || "https://images.pexels.com/photos/28961402/pexels-photo-28961402.jpeg"}
                    loading="eager"
                    onError={(e) => {
                        e.target.src = "https://images.pexels.com/photos/1651332/pexels-photo-1651332.jpeg";
                    }}
                />
                                        ...
                                        >
                                            ...
                                            >
                                                <img
                                                    ...
                                                    loading="lazy"
                                                    onError={(e) => {
                                                        e.target.src = "https://images.pexels.com/photos/736220/pexels-photo-736220.jpeg";
                                                    }}
                                                />
                                                {selectedImage === index && (
                        ...
                        <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-xl">
                            <div className="relative">
                                ...
                                <img
                                    ...
                                    className={`w-full h-[400px] object-contain bg-gray-50 transition-all duration-500 ${
                                        imageLoading
                                            ? "opacity-0"
                                            : "opacity-100"
                                    }`}
                                ...
                                <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm text-gray-800 text-sm font-medium px-4 py-2 rounded-full shadow border border-gray-200">
                                    ...
                                    <span>{inscription.images?.length || 1}</span>
                                </div>
                            </div>
                        </div>
