...
const EditInscriptionForm = ({
    ...
    useEffect(() => {
        if (editingInscription) {
            ...
            // Set developer field values
            setValue("dev_description", editingInscription.dev_description || "");
            setValue("dev_background", editingInscription.dev_background || "");
            setValue("dev_text", editingInscription.dev_text || "");
            setValue("dev_translation", editingInscription.dev_translation || "");
            setValue("dev_references", editingInscription.dev_references || "");
            setValue("dev_glossary", editingInscription.dev_glossary || "");
                ...
                <div className="h-full flex flex-col px-4 sm:px-6 py-4 sm:py-6 text-gray-800">
                    ...
                    <div className="overflow-y-auto flex-1 pr-2 space-y-4 sm:space-y-6">
                        ...
                        >
                            ...
                            <div>
                                <label className="block mb-2 font-medium text-base sm:text-lg">
                                    Developer Description <span className="text-gray-500 text-sm">(For internal use)</span>
                                </label>
                                <Controller
                                    ...
                                    render={({ field }) => (
                                        <div className="rounded overflow-hidden">
                                            <ReactQuill
                                                ...
                                                modules={quillModules}
                                                formats={quillFormats}
                                                style={quillStyle("dev_description")}
                                                className="rounded h-auto quill-custom"
                                                placeholder="Developer notes about the description..."
                                            />
                                        </div>
                                    )}
                                />
                            ...
                            <div>
                                <label className="block mb-2 font-medium text-base sm:text-lg">
                                    Developer Background <span className="text-gray-500 text-sm">(For internal use)</span>
                                </label>
                                <Controller
                                    name="dev_background"
                                    control={control}
                                    render={({ field }) => (
                                        <div className="rounded overflow-hidden">
                                            <ReactQuill
                                                ...
                                                modules={quillModules}
                                                formats={quillFormats}
                                                style={quillStyle("dev_background")}
                                                className="rounded h-auto quill-custom"
                                                placeholder="Developer notes about the background..."
                                            />
                                        </div>
                                    )}
                                />
                            ...
                            <div>
                                <label className="block mb-2 font-medium text-base sm:text-lg">
                                    Developer Text <span className="text-gray-500 text-sm">(For internal use)</span>
                                </label>
                                <Controller
                                    name="dev_text"
                                    control={control}
                                    render={({ field }) => (
                                        <div className="rounded overflow-hidden">
                                            <ReactQuill
                                                ...
                                                className="rounded h-auto quill-custom"
                                                placeholder="Developer notes about the text..."
                                            />
                                        </div>
                                    )}
                                />
                            ...
                            <div>
                                <label className="block mb-2 font-medium text-base sm:text-lg">
                                    Developer Translation <span className="text-gray-500 text-sm">(For internal use)</span>
                                </label>
                                <Controller
                                    name="dev_translation"
                                    control={control}
                                    render={({ field }) => (
                                        <div className="rounded overflow-hidden">
                                            <ReactQuill
                                                ref={quillRefs.dev_translation}
                                                theme="snow"
                                                value={field.value || ""}
                                                onChange={field.onChange}
                                                onBlur={field.onBlur}
                                                modules={quillModules}
                                                formats={quillFormats}
                                                style={quillStyle("dev_translation")}
                                                className="rounded h-auto quill-custom"
                                                placeholder="Developer notes about the translation..."
                                            />
                                        </div>
                                    )}
                                />
                            ...
                            <div>
                                <label className="block mb-2 font-medium text-base sm:text-lg">
                                    Developer References <span className="text-gray-500 text-sm">(For internal use)</span>
                                </label>
                                <Controller
                                    name="dev_references"
                                    control={control}
                                    render={({ field }) => (
                                        <div className="rounded overflow-hidden">
                                            <ReactQuill
                                                ...
                                                modules={quillModules}
                                                formats={quillFormats}
                                                style={quillStyle("dev_references")}
                                                className="rounded h-auto quill-custom"
                                                placeholder="Developer notes about the references..."
                                            />
                                        </div>
                                    )}
                                />
                            ...
                            <div>
                                <label className="block mb-2 font-medium text-base sm:text-lg">
                                    Developer Glossary <span className="text-gray-500 text-sm">(For internal use)</span>
                                </label>
                                <Controller
                                    name="dev_glossary"
                                    control={control}
                                    render={({ field }) => (
                                        <div className="rounded overflow-hidden">
                                            <ReactQuill
                                                ...
                                                modules={quillModules}
                                                formats={quillFormats}
                                                style={quillStyle("dev_glossary")}
                                                className="rounded h-auto quill-custom"
                                                placeholder="Developer notes about the glossary..."
                                            />
                                        </div>
                                    )}
                                />
