...
const EditInscriptionForm = ({
    ...
    useEffect(() => {
        if (editingInscription) {
            ...
            // Set Quill content values in form - Romanized versions
            setValue("description", editingInscription.description || "");
            setValue("background", editingInscription.background || "");
            setValue("text", editingInscription.text || "");
            setValue("translation", editingInscription.translation || "");
                ...
                <div className="h-full flex flex-col px-4 sm:px-6 py-4 sm:py-6 text-gray-800">
                    ...
                    <div className="overflow-y-auto flex-1 pr-2 space-y-4 sm:space-y-6">
                        ...
                        >
                            ...
                            <div>
                                <label className="block mb-2 font-medium text-base sm:text-lg">
                                    Description (Devanagari) <span className="text-gray-500 text-sm"></span>
                                </label>
                                <Controller
                                    ...
                                    render={({ field }) => (
                                        <div className="rounded overflow-hidden">
                                            <ReactQuill
                                                ...
                                                style={quillStyle}
                                                className="rounded h-auto quill-custom"
                                                placeholder={quillPlaceholders.dev_description}
                                            />
                                        </div>
                                    )}
                                />
                            ...
                            <div>
                                <label className="block mb-2 font-medium text-base sm:text-lg">
                                    Background (Devanagari) <span className="text-gray-500 text-sm"></span>
                                </label>
                                <Controller
                                    name="dev_background"
                                    control={control}
                                    render={({ field }) => (
                                        <div className="rounded overflow-hidden">
                                            <ReactQuill
                                                ...
                                                style={quillStyle}
                                                className="rounded h-auto quill-custom"
                                                placeholder={quillPlaceholders.dev_background}
                                            />
                                        </div>
                                    )}
                                />
                            ...
                            <div>
                                <label className="block mb-2 font-medium text-base sm:text-lg">
                                    Text (Devanagari) <span className="text-gray-500 text-sm"></span>
                                </label>
                                <Controller
                                    name="dev_text"
                                    control={control}
                            ...
                            <div>
                                <label className="block mb-2 font-medium text-base sm:text-lg">
                                    Translation (Devanagari) <span className="text-gray-500 text-sm"></span>
                                </label>
                                <Controller
                                    ...
                                    render={({ field }) => (
                                        <div className="rounded overflow-hidden">
                                            <ReactQuill
                                                ...
                                                style={quillStyle}
                                                className="rounded h-auto quill-custom"
                                                placeholder={quillPlaceholders.dev_translation}
                                            />
                                        </div>
                                    )}
                                />
                            ...
                            <div>
                                <label className="block mb-2 font-medium text-base sm:text-lg">
                                    References (Devanagari) <span className="text-gray-500 text-sm"></span>
                                </label>
                                <Controller
                                    name="dev_references"
                                    control={control}
                                    render={({ field }) => (
                                        <div className="rounded overflow-hidden">
                                            <ReactQuill
                                                ...
                                                style={quillStyle}
                                                className="rounded h-auto quill-custom"
                                                placeholder={quillPlaceholders.dev_references}
                                            />
                                        </div>
                                    )}
                                />
                            ...
                            <div>
                                <label className="block mb-2 font-medium text-base sm:text-lg">
                                    Glossary (Devanagari) <span className="text-gray-500 text-sm"></span>
                                </label>
                                <Controller
                                    name="dev_glossary"
                                    control={control}
                                    render={({ field }) => (
                                        <div className="rounded overflow-hidden">
                                            <ReactQuill
                                                ...
                                                style={quillStyle}
                                                className="rounded h-auto quill-custom"
                                                placeholder={quillPlaceholders.dev_glossary}
                                            />
                                        </div>
                                    )}
                                />
