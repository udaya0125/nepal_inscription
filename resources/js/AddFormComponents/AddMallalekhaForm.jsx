...
// const AddMallalekhaForm = ({ showForm, setShowForm, editingMallalekha, setEditingMallalekha, handleUpdate, setReloadTrigger }) => {
...
//     // Handle Create Mallalekha
//     const handleCreate = async (formData) => {
//         try {
//             await axios.post(route("ourmallalekha.store"), formData, {
//                 headers: {
...
//         } catch (error) {
//             console.log("Error creating mallalekha", error);
//             throw error;
//         }
//     };
...
//             if (mallalekhaForm[key] !== null && mallalekhaForm[key] !== "") {
//                 formData.append(key, mallalekhaForm[key]);
//             }
//         }
//         try {
//             setSubmitting(true);
...
//             if (editingMallalekha) {
//                 // Editing existing mallalekha
//                 await handleUpdate(formData, editingMallalekha.id);
//             } else {
//                 // Creating new mallalekha
...
// export default AddMallalekhaForm;
...
const AddMallalekhaForm = ({
    ...
    const [mallalekhaForm, setMallalekhaForm] = useState(emptyForm);
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-xl max-w-2xl w-full p-6 shadow-xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold text-gray-800">
                        {editingMallalekha ? "Edit Mallalekha" : "Add New Mallalekha"}
                    </h2>
                    <button
                        type="button"
                        onClick={() => {
