        ...
        <>
            ...
            >
                ...
                >
                    ...
                    {/* Separator with "Text Written" label */}
                    {!isCollapsed && (
                    ...
                    <Link
                        ...
                        className={`
                            flex items-center rounded-lg transition-colors duration-200 group relative
                            ${isCollapsed ? "p-3 justify-center" : "p-3"}
                            ${isActive("/mallalekha") ? "bg-blue-50 text-blue-700 font-semibold border-l-4 border-blue-600" : "text-gray-600 hover:bg-blue-50 hover:text-blue-700"}
                        `}
                        title={isCollapsed ? "Mallalekha" : ""}
                    >
                        <ScrollText
                            className={`w-5 h-5 ${isActive("/mallalekha") ? "text-blue-600" : "text-gray-500 group-hover:text-blue-600"}`}
                        />
